  ...
  <div class="text-gray-900 text-sm">
    ...
    >
      ...
      <div class="flex items-center space-x-4 text-white">
        ...
        <a href="#" class="flex items-center hover:text-gray-400">
          <img
            src="https://avatars.githubusercontent.com/u/31560529?s=40&v=4"
            alt="avatar"
    ...
    <ul class="repo-nav border-gray-400 flex items-center px-8 mt-4">
      ...
      <li>
        ...
        >
          ...
          <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">12</div>
        </a>
      </li>
      <li>
        <a
